...
public enum CraftingUnitType implements ICraftingUnitType {
    ...
    public BlockEntry<CraftingUnitBlock> getDefinition() {
        return switch (this) {
            case STORAGE_1M -> GTIBlocks.CRAFTING_STORAGE_1M;
            case STORAGE_4M -> GTIBlocks.CRAFTING_STORAGE_4M;
            case STORAGE_16M -> GTIBlocks.CRAFTING_STORAGE_16M;
            case STORAGE_64M -> GTIBlocks.CRAFTING_STORAGE_64M;
            case STORAGE_256M -> GTIBlocks.CRAFTING_STORAGE_256M;
            case STORAGE_MAX -> GTIBlocks.CRAFTING_STORAGE_MAX;
        };
    }
