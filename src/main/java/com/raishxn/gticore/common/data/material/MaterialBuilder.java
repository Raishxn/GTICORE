...
import com.raishxn.gticore.api.data.info.GTIMaterialIconSet;
import com.raishxn.gticore.api.item.tool.GTIToolType;
import com.raishxn.gticore.common.data.GTIElements;
...
import static com.raishxn.gticore.common.data.GTIMaterials.*;
...
public class MaterialBuilder {
    ...
    public static void init() {
        ...
        Adamantium = new Material.Builder(GTCEu.id("adamantium"))
                ...
                .element(GTIElements.ADAMANTIUM)
                .color(0xefbe35)
                .iconSet(METALLIC)
        ...
        Quantanium = new Material.Builder(GTCEu.id("quantanium"))
                ...
                .element(GTIElements.QUANTANIUM)
                .color(0x0dff02)
                .iconSet(METALLIC)
        ...
        Vibranium = new Material.Builder(GTCEu.id("vibranium"))
                ...
                .element(GTIElements.VIBRANIUM)
                .color(0xff0000)
                .iconSet(METALLIC)
                .toolStats(ToolProperty.Builder.of(1.0F, 1.0F, 100, 10, GTToolType.DRILL_LV).build())
                .flags(GTIMaterialFlags.GENERATE_NANOSWARM, GENERATE_ROTOR, GENERATE_FRAME)
                .buildAndRegister();
        ...
        Draconium = new Material.Builder(GTCEu.id("draconium"))
                ...
                .fluid()
                .blastTemp(19200)
                .element(GTIElements.DRACONIUM)
                .color(0xa300cc)
                .iconSet(RADIOACTIVE)
                .flags(GTIMaterialFlags.GENERATE_NANOSWARM, GENERATE_ROTOR, GENERATE_FRAME, NO_SMELTING)
                .buildAndRegister();
        ...
        Crystalmatrix = new Material.Builder(GTCEu.id("crystalmatrix"))
                ...
                .element(GTIElements.CRYSTALMATRIX)
                .color(0x33ffff)
                .iconSet(RADIOACTIVE)
                .flags(GENERATE_SPRING, GENERATE_SPRING_SMALL)
        ...
        CosmicNeutronium = new Material.Builder(GTCEu.id("cosmicneutronium"))
                ...
                .element(GTIElements.COSMICNEUTRONIUM)
                .color(0x000d1a)
                .iconSet(new MaterialIconSet("cosmicneutronium", BRIGHT))
                .flags(GTIMaterialFlags.GENERATE_NANOSWARM, GENERATE_SPRING, GENERATE_FINE_WIRE,
        ...
        Echoite = new Material.Builder(GTCEu.id("echoite"))
                ...
                .element(GTIElements.ECHOITE)
                .color(0x26734d)
                .iconSet(METALLIC)
                .flags(GENERATE_ROD, GENERATE_FINE_WIRE)
                .cableProperties(GTValues.V[GTValues.UIV], 32, 0, true)
                .toolStats(ToolProperty.Builder.of(6.0F, 100.0F, 64, 6, GTIToolType.VAJRA).magnetic()
                        .unbreakable().build())
                .buildAndRegister();
        ...
        Legendarium = new Material.Builder(GTCEu.id("legendarium"))
                ...
                .element(GTIElements.LEGENDARIUM)
                .color(0x00ffff)
                .iconSet(RADIOACTIVE)
                .flags(GENERATE_FINE_WIRE)
        ...
        DraconiumAwakened = new Material.Builder(GTCEu.id("draconiumawakened"))
                ...
                .element(GTIElements.DRACONIUMAWAKENED)
                .color(0xcc6600)
                .iconSet(RADIOACTIVE)
                .flags(GENERATE_FINE_WIRE)
        ...
        Adamantine = new Material.Builder(GTCEu.id("adamantine"))
                ...
                .element(GTIElements.ADAMANTINE)
                .color(0xe6e600)
                .iconSet(METALLIC)
                .flags(GENERATE_FINE_WIRE)
        ...
        Starmetal = new Material.Builder(GTCEu.id("starmetal"))
                ...
                .element(GTIElements.STARMETAL)
                .color(0x0000e6)
                .iconSet(METALLIC)
                .flags(GTIMaterialFlags.GENERATE_NANOSWARM, GENERATE_FINE_WIRE)
        ...
        Orichalcum = new Material.Builder(GTCEu.id("orichalcum"))
                ...
                .element(GTIElements.ORICHALCUM)
                .color(0xff78c9)
                .iconSet(METALLIC)
                .flags(GTIMaterialFlags.GENERATE_NANOSWARM, GENERATE_ROUND, GENERATE_ROTOR, GENERATE_GEAR,
        ...
        Infuscolium = new Material.Builder(GTCEu.id("infuscolium"))
                ...
                .element(GTIElements.INFUSCOLIUM)
                .color(0xff77ff)
                .iconSet(RADIOACTIVE)
                .flags(GTIMaterialFlags.GENERATE_NANOSWARM, GENERATE_ROUND, GENERATE_ROTOR, GENERATE_GEAR,
                        GENERATE_SMALL_GEAR, GENERATE_LONG_ROD)
        ...
        Eternity = new Material.Builder(GTCEu.id("eternity"))
                ...
                .element(GTIElements.ETERNITY)
                .iconSet(new MaterialIconSet("eternity"))
                .flags(GTIMaterialFlags.GENERATE_NANOSWARM, GENERATE_FOIL, GENERATE_FRAME)
                .buildAndRegister();

        Magmatter = new Material.Builder(GTCEu.id("magmatter"))
                .ingot()
                .liquid(new FluidBuilder().customStill())
                .element(GTIElements.MAGMATTER)
        ...
        DegenerateRhenium = new Material.Builder(GTCEu.id("degenerate_rhenium"))
                ...
                .fluid()
                .color(0x4646ff)
                .element(GTIElements.DEGENERATE_REHENIUM)
                .iconSet(RADIOACTIVE)
        ...
        HeavyQuarkDegenerateMatter = new Material.Builder(
                ...
                .element(GTIElements.HEAVY_QUARK_DEGENERATE_MATTER)
        ...
        QuantumChromodynamicallyConfinedMatter = new Material.Builder(
                ...
                .fluid()
                .plasma()
                .element(GTIElements.QUANTUMCHROMODYNAMICALLY_CONFINED_MATTER)
        ...
        TranscendentMetal = new Material.Builder(GTCEu.id("transcendentmetal"))
                .ingot()
                .fluid()
                .element(GTIElements.TRANSCENDENTMETAL)
                .color(0xffffff)
                .iconSet(GTIMaterialIconSet.CUSTOM_TRANSCENDENT_MENTAL)
                .flags(GTIMaterialFlags.GENERATE_NANOSWARM, GENERATE_ROUND, GENERATE_ROTOR, GENERATE_GEAR,
                        GENERATE_SMALL_GEAR, GENERATE_LONG_ROD)
                .buildAndRegister();
        ...
        Uruium = new Material.Builder(GTCEu.id("uruium"))
                ...
                .element(GTIElements.URUIUM)
                .color(0x87ceeb)
                .flags(GTIMaterialFlags.GENERATE_NANOSWARM)
                .iconSet(METALLIC)
        ...
        MagnetohydrodynamicallyConstrainedStarMatter = new Material.Builder(GTCEu.id("magnetohydrodynamicallyconstrainedstarmatter"))
                ...
                .element(GTIElements.RAW_STAR_MATTER)
        ...
        WhiteDwarfMatter = new Material.Builder(GTCEu.id("white_dwarf_mtter"))
                .ingot()
                .fluid()
                .element(GTIElements.STAR_MATTER)
                .color(0xffffff)
                .flags(GTIMaterialFlags.GENERATE_NANOSWARM, GENERATE_FINE_WIRE)
                .iconSet(BRIGHT)
                .buildAndRegister();
        ...
        AstralTitanium = new Material.Builder(GTCEu.id("astraltitanium"))
                ...
                .fluid()
                .plasma()
                .element(GTIElements.ASTRALTITANIUM)
                .color(0xf6cbf6)
                .flags(GENERATE_GEAR)
                .iconSet(BRIGHT)
                .buildAndRegister();
        ...
        CelestialTungsten = new Material.Builder(GTCEu.id("celestialtungsten"))
                ...
                .fluid()
                .plasma()
                .element(GTIElements.CELESTIALTUNGSTEN)
                .color(0x303030)
                .flags(GENERATE_GEAR)
                .iconSet(BRIGHT)
                .buildAndRegister();
        ...
        Ytterbium178 = new Material.Builder(GTCEu.id("ytterbium_178"))
                .fluid()
                .element(GTIElements.YITTERBIUM178)
                .color(0xffffff)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        QuarkGluon = new Material.Builder(GTCEu.id("quark_gluon"))
                .plasma()
                .color(0x7a00da)
                .element(GTIElements.QUARK_GLUON)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        HeavyQuarks = new Material.Builder(GTCEu.id("heavy_quarks"))
                .gas()
                .color(0x007000)
                .element(GTIElements.HEAVY_QUARKS)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        LightQuarks = new Material.Builder(GTCEu.id("light_quarks"))
                .gas()
                .color(0x0000ce)
                .element(GTIElements.LIGHT_QUARKS)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Titanium50 = new Material.Builder(GTCEu.id("titanium_50"))
                .ingot()
                .fluid()
                .element(GTIElements.TITANIUM50)
                .blastTemp(1942)
                .color(0xd58eed)
                .iconSet(METALLIC)
                .buildAndRegister();
        ...
        HeavyLeptonMixture = new Material.Builder(GTCEu.id("heavy_lepton_mixture"))
                .gas()
                .color(0x3ad931)
                .element(GTIElements.HEAVY_LEPTON_MIXTURE)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        HeavyQuarkEnrichedMixture = new Material.Builder(
                ...
                .gas()
                .color(0xececec)
                .element(GTIElements.HEAVY_QUARK_ENRICHED_MIXTURE)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        DenseNeutron = new Material.Builder(GTCEu.id("dense_neutron"))
                .plasma()
                .color(0x9ce89c)
                .element(GTIElements.DENSE_NEUTRON)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        CosmicMesh = new Material.Builder(GTCEu.id("cosmic_mesh"))
                ...
                .fluid()
                .color(0x181878)
                .element(GTIElements.COSMIC_MESH)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        HydroiodicAcid = new Material.Builder(GTCEu.id("hydroiodic_acid"))
                ...
                .color(0x0382e2)
                .iconSet(GTIMaterialIconSet.LIMPID)
                .buildAndRegister();
        ...
        SpaceTime = new Material.Builder(GTCEu.id("spacetime"))
                ...
                .element(GTIElements.SPACETIME)
                .iconSet(new MaterialIconSet("spacetime"))
                .flags(GTIMaterialFlags.GENERATE_NANOSWARM, NO_UNIFICATION)
        ...
        FumingNitricAcid = new Material.Builder(GTCEu.id("fuming_nitric_acid"))
                .fluid()
                .components(Hydrogen, 1, Nitrogen, 1, Oxygen, 3)
                .color(0xB46800).iconSet(GTIMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        Perfluorobenzene = new Material.Builder(GTCEu.id("perfluorobenzene"))
                ...
                .color(0x15752B).iconSet(GTIMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        Trimethylsilane = new Material.Builder(GTCEu.id("trimethylsilane"))
                ...
                .color(0x7D2FC3).iconSet(GTIMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();

        Trimethylchlorosilane = new Material.Builder(GTCEu.id("trimethylchlorosilane"))
                .fluid()
                .color(0x591399).iconSet(GTIMaterialIconSet.LIMPID)
        ...
        EthylTrifluoroacetate = new Material.Builder(GTCEu.id("ethyl_trifluoroacetate"))
                ...
                .color(0x93A658).iconSet(GTIMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        AcetylChloride = new Material.Builder(GTCEu.id("acetyl_chloride"))
                ...
                .color(0xD1B117).iconSet(GTIMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        KryptonDifluoride = new Material.Builder(GTCEu.id("krypton_difluoride"))
                ...
                .color(0x3FF12B).iconSet(GTIMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        Trimethylamine = new Material.Builder(GTCEu.id("trimethylamine"))
                .fluid()
                .color(0xCEA67D).iconSet(GTIMaterialIconSet.LIMPID)
        ...
        SodiumHexafluoroaluminate = new Material.Builder(GTCEu.id("sodium_hexafluoroaluminate"))
                ...
                .color(0xA47732).iconSet(GTIMaterialIconSet.LIMPID)
                .buildAndRegister();

        DirtyHexafluorosilicicAcid = new Material.Builder(GTCEu.id("dirty_hexafluorosilicic_acid"))
                .fluid()
                .color(0xDA387D).iconSet(GTIMaterialIconSet.LIMPID)
        ...
        DiluteHexafluorosilicicAcid = new Material.Builder(GTCEu.id("dilute_hexafluorosilicic_acid"))
                .fluid()
                .color(0x49DF68).iconSet(GTIMaterialIconSet.LIMPID)
        ...
        TritiumHydride = new Material.Builder(GTCEu.id("tritium_hydride"))
                ...
                .color(0xBA0202).iconSet(GTIMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        DustyLiquidHeliumIII = new Material.Builder(GTCEu.id("dusty_liquid_helium_iii"))
                ...
                .color(0x774060).iconSet(GTIMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        Ozone = new Material.Builder(GTCEu.id("ozone"))
                .fluid()
                .components(Oxygen, 3)
                .color(0x0176C4).iconSet(GTIMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        RareEarthChlorides = new Material.Builder(GTCEu.id("rare_earth_chlorides"))
                ...
                .color(0xBDB76B).iconSet(GTIMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
