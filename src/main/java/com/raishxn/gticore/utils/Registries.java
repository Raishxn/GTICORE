...
public class Registries {
    ...
    public static Item getItem(String s) {
        ...
        if (i == Items.AIR) {
            GTICORE.LOGGER.atError().log("Item with ID {}not found", s);
    ...
    public static Block getBlock(String s) {
        ...
        if (b == Blocks.AIR) {
            GTICORE.LOGGER.atError().log("No block with ID {}found", s);
    ...
    public static Fluid getFluid(String s) {
        ...
        if (f == Fluids.EMPTY) {
            GTICORE.LOGGER.atError().log("No fluid with ID {}found", s);
            return Fluids.WATER;
        }
        return f;
    }
